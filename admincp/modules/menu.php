...
<div class="menu">
		<ul>
			<li ><a href="index.php?ac=logout" style="background: yellow;border-radius: 5px;font-weight: bold;color: #31CC86;"><img src="../img/smallBanners/login.png">                Đăng xuất</a></li><hr>
			...
			<li><a href="#">Quản lý đơn hàng</a></li><hr>
